...
const API_KEY = 'api_key=76f9e4736ce1d69a0c54a33efbc9d68a';
...
function showMovies(data) {
    ...
    data.forEach(movie => {
        const {title, poster_path, vote_average, overview, id, video} = movie;
...
imgArray[0] = "spider-man.jpg"
imgArray[1] = "sooryavanshi.jpg"
